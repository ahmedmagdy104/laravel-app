    ...
    <body>
        ...
        <div class="sign-up-form">
            ...
            <form>
                ...
                <input type="email" class="input-box" placeholder="Enter e-mail Or mobile phone">
                ...
                <input type="radio" name="gender"> Custom <br>
                ...
                <p> Already have an Account? <a href="../login%20form/log%20in.html">log in</a> </p>
